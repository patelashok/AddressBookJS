...
let ashok = new Contact("Ashok","Patel","Raipur","Pali","Rajasthan",306207,86434433434,"ak@gmail.com");
console.log(ashok.toString());

//UC2 - Ability to ensure valid Contact is Added in Address Book
var firstName = "Varun";
var lastName = "Kumawat";
var address = "Raipur";
var city = "Pali";
var state = "Rajasthan";
var zip = 306307;
var mobileNumber = "91 9887787676";
var email = "vk@gmail.com";
try {
    if (validateFirstName(firstName)&&validateLastName(lastName)&&validateAddress(address)&&validateCity(city)&&validateState(state)&&validateZip(zip)&&validateMobileNumber(mobileNumber)&&validateEmail(email)) {
        var varun = new Contact(firstName,lastName,address,city,state,zip,mobileNumber,email);
        console.log(varun.toString());
    }
} catch (error) {
    console.log(error);
}
...
addressBook.push(ashok);
addressBook.push(varun);
